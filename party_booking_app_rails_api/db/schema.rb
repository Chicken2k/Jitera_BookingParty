...
ActiveRecord::Schema[7.0].define(version: 2023_05_05_094616) do
  ...
  create_table "parties", force: :cascade do |t|
    ...
    t.datetime "partystarttime", precision: nil, null: false
    t.text "describe"
  ...
  create_table "partybookings", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "party_id"
    t.bigint "user_id"
    t.index ["party_id"], name: "index_partybookings_on_party_id"
    t.index ["user_id"], name: "index_partybookings_on_user_id"
  end
  ...
  add_foreign_key "parties", "admins"
  add_foreign_key "partybookings", "parties"
  add_foreign_key "partybookings", "users"
end
